...
public class TaskManagerUserSteps extends TaskManagerSteps{
	...
	public void i_claim_socn() throws InterruptedException
	
	{
		IntDataContainer dat = get_data_for_page(TaskManagerEditPage).getContainer("TaskManagerEditPageforSOCNclaim");
		fillFields(TaskManagerEditPage,dat.getMandatoryFields());
		Thread.sleep(70000);
	...
	public void i_click_search4() throws InterruptedException 
	
	{
		TaskManagerEditPage.search4.click();
		Thread.sleep(10000);
	}

	public void i_clear_out_remaining_fields_socn_complete() throws InterruptedException
	...
	public void i_click_search5() throws InterruptedException
	
	{
		TaskManagerEditPage.search5.click();
	Thread.sleep(10000);
		
	}

	public void i_cliam_socn_complete() throws InterruptedException 
	
	{
		IntDataContainer dat = get_data_for_page(TaskManagerEditPage).getContainer("TaskManagerEditPageforsocncomplete");
		fillFields(TaskManagerEditPage,dat.getMandatoryFields());
		Thread.sleep(80000);
	}

	public void i_click_search6() throws InterruptedException
	{
		TaskManagerEditPage.search6.click();
		Thread.sleep(10000);
		
	}

	public void i_click_on_WorkGroupTasks_twice() throws InterruptedException 
	
	
	{
		
		TaskManagerEditPage.search7.click();
		Thread.sleep(10000);
